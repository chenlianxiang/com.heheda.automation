...
public class ImportExeclUtil {
     ...
     * @return
     */
    private List<List<String>> readData(Workbook workbook){
...
//                        case HSSFCell.CELL_TYPE_ERROR: // 故障
    ...
    public static <T> T readDataT(Workbook workbook,T t,InputStream inputStream,Integer[]... integers) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        Sheet sheet=workbook.getSheetAt(0);
        ...
        for (int f=0;f<count;f++){
            ...
            //判断当前字段是否有注解
            boolean fidldHasAnno=field.isAnnotationPresent(IsNeeded.class);

           if (fidldHasAnno){
               IsNeeded anno=field.getAnnotation(IsNeeded.class);
               boolean isNeeded=anno.isNeeded();
